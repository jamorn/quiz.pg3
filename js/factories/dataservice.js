...
(function(){
    ...
    var quizQuestions  = [
        {
            type: "text",
            text: "กรณีเกิดเหตุสารเคมีอันตรายรั่วไหล การกั้นเขต (กำหนดโซน) แบ่งเป็นกี่โซน อะไรบ้าง",
            possibilities: [
                {
                    answer: "มี 3 โซน คือ Hot Zone , Warm Zone , Zero Zone"
                },
                {
                    answer: "มี 3 โซน คือ Hot Zone , Warm Zone , Cold Zone"
                },
                {
                    answer: "มี 2 โซน คือ Hot Zone , Warm Zone"
                },
                {
                    answer: "มี 2 โซน คือ Cold Zone , Warm Zone"
                }
            ],
            selected: null,
            correct: null
        ...
        {
            type: "text",
            text: "ข้อใดไม่ไช่ อันตรายจากสภาพแวดล้อมจากการทำงาน",
            possibilities: [
                {
                    answer: "อันตรายจากสภาพแวดล้อมที่มีเสียงดัง"
                },
                {
                    answer: "อันตรายจากการไม่ทำงานตามขั้นตอนที่กำหนด"
                },
                {
                    answer: "อันตรายจากสภาพแวดล้อมทางเคมี"
                },
                {
                    answer: "อันตรายจากสภาพแวดล้อมทางรังสี"
                }
            ],
            selected: null,
            correct: null
        },
        {
            ...
            possibilities: [
                {
                    answer: "9 ชั่วโมงตั้งแต่ 85 dB(A) ขึ้นไป"
                },
                {
                    answer: "9 ชั่วโมงตั้งแต่  110 dB(A) ขึ้นไป  "
                },
                {
                    answer: "8 ชั่วโมงตั้งแต่   95 dB(A) ขึ้นไป    "
                },
                {
                    answer: "8 ชั่วโมงตั้งแต่   85 dB(A) ขึ้นไป "
                }
            ],
            selected: null,
            correct: null
        ...
        {
            type: "text",
            text: "กรณีที่พบเห็นเหตุฉุกเฉินควรทำอย่างไรเป็นอันดับแรก",
            possibilities: [
                {
                    answer: "วิ่งไปที่จุดรวมพลของแผนก"
                },
                {
                    answer: "เข้าระงับเหตุเบื้องต้นทันที"
                },
                {
                    answer: "แจ้งหัวหน้างาน"
                },
                {
                    answer: "วิ่งไปบอกเพื่อให้เข้าระงับเหตุแทน"
                }
            ],
            selected: null,
            correct: null
        ...
        {
            type: "text",
            text: "ข้อใดปฏิบัติได้ถูกต้อง ในการตัดไฟ เครื่องจักรก่อนการซ่อมบำรุง",
            possibilities: [
                {
                    answer: "พนักงานตัดไฟประจำ Substation ทำการตัดไฟ ใน feeder ที่ต้องการตัดไฟ ไม่ต้องแขวน Tag ตัดไฟ"
                },
                {
                    answer: "พนักงานตัดไฟประจำ Substation  ใช้อุปกรณ์ Lock Out คล้องเข้ากับ อุปกรณ์จ่ายไฟ  (circuit breaker)โดยไม่ต้องใช้กุญแจ Lock"
                },
                {
                    answer: "พนักงานตัดไฟประจำ Sub. แจ้งทางพนักงาน Production ให้ทำการ Test switch หน้างาน"
                },
                {
                    answer: "พนักงาน Production ผู้ออก TAG ทำการล็อคด้วยกุญแจ ของ Production และ  พนักงานซ่อมบำรุง ผู้ขอตัดไฟทำการล็อค ด้วยกุญแจ ของทีมงานตัวเอง และเก็บลูกกุญแจไว้กับตัวเอง"
                }
            ],
            selected: null,
            correct: null
